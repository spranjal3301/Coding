...
//                 * await will wait for each promise to resolve before moving to the next one. This can be useful when the order of execution matters or when each operation depends on the result of the previous one.
// * 2. Parallel Execution:
//                 * Promise.all will execute all promises concurrently, and it will wait for all of them to resolve or for any of them to reject. This is more efficient when the promises are independent of each