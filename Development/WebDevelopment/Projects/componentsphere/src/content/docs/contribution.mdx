...
This guide will help you understand the directory structure and provide detailed instructions on how to add a new component to MagicUI.
...
```bash
npx shadcn@latest add "https://example.com/r/example-component"
```
