...
import template from "lodash.template"; //-create templet string
import { rimraf } from "rimraf"; //- remove dir rm -rf with robust and reliable
import { Project, ScriptKind, SyntaxKind } from "ts-morph"; //-simplify create ts/js files 
import { z } from "zod";
...
const REGISTRY_PATH = path.join(process.cwd(), "public/r"); //- current/working/dir/public/r
        ...
        chunks = await Promise.all(
          components.map(async (component, index) => {
            ...
            const targetFilePath = path.join(
              cwd(),
              `src/registry/${style.name}/${type}/${chunkName}.tsx`, //?change
            );
...
// ----------------------------------------------------------------------------
// Build public/r/styles/[style]/[name].json.
// ----------------------------------------------------------------------------
...
// ----------------------------------------------------------------------------
// Build public/r/styles/[name]/index.json.
// ----------------------------------------------------------------------------
