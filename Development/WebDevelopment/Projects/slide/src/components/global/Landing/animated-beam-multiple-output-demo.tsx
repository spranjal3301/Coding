      ...
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-12">
            ...
            <Image src={"/instagram.svg"} width={18} height={18} alt="instagram" />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          ...
          <Circle ref={div3Ref}>
          <Image src={"/chat.svg"} width={18} height={18} alt="chats" />
          </Circle>
          <Circle ref={div4Ref}>
          <Image src={"/reels.svg"} width={16} height={16} alt="reels" />
          </Circle>
          <Circle ref={div5Ref}>
            {/* <Icons.messenger /> */}
            <Image src={"/mention.svg"} width={18} height={18} alt="mention" />
          </Circle>
        </div>
      </div>
