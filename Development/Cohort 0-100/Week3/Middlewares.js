...
app.get('/',(req,res)=>{
    usernameValidation(req.query.username,req.query.password)?res.send('Hello World!'):res.send('Invalid username or password');
...
//*app.use is used to call middleware function for all routes (get,put,post,delete) or common Middleware function for all routes
//~comes before all routes
